...
const Calculator = {
    ...
    // this will hold the operter, we set it to null for now
    operator:null, 
};
...
function Input_Digit(digit) {
    ...
    // we are checking to see if Wait_Second is true and set
...
// this section handeles decimal points
...
function Handle_Operator(Next_Operator) {
    ...
    //when an operator key is pressed, we convert the current numver
    ...
    if (First_Operand == null) {
        ...
        // in the Perform_Calculatiion object and the function that matches the 
        // operator os executed 

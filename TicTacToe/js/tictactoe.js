...
let activePlayer = 'X';
// this array stores an array of moves. We use the to determinewin conditions
let selectedSquares = [];

// this function is forplacing an x or o in a square
function placeXorO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //returning true is needed for our computersTurns() function to work.
        return true;
    }
    ...
    function computersTurn() {
        ...
        while(!success) {
            ...
            if (placeXorO(pickASquare)) {
                ...
                // this changes pur boolean and ends the loop
                success = true;
            };
        }
    }
...
function checkWinConditions() {
    ...
    // this condition checks for tie. if none of the above conditions regester and 9
    // squares are selected the code executed
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        //these 3 variables will be used to for 3 in a row
        const a = selectedSquares.includes(squareA)
        const b = selectedSquares.includes(squareB)
        const c = selectedSquares.includes(squareC)
        // if the 3 variables we pass are all included in our array true is
        // returned and our else if condition executes the drawWinLinefunction
